...
def merge(inputs, mode, name, concat_axis=-1):
...
def densenet121_model(img_rows,
    ...
    if K.image_dim_ordering() == 'th':
        ...
        weights_path = weight_path_prefix + 'imagenet_models/densenet121_weights_th.h5'
    else:
        # Use pre-trained weights for Tensorflow backend
        weights_path = weight_path_prefix + 'imagenet_models/densenet121_weights_tf.h5'
...
def dense_block(x,
    ...
    for i in range(nb_layers):
        ...
        x = conv_block(concat_feat, stage, branch, growth_rate, dropout_rate,
                       weight_decay)
        concat_feat = merge([concat_feat, x],
                            mode='concat',
